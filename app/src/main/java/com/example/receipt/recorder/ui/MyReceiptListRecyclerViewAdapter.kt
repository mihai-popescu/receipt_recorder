 ...
 */
class MyReceiptListRecyclerViewAdapter(
    private val values: List<PlaceholderItem>
) : RecyclerView.Adapter<MyReceiptListRecyclerViewAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {

        return ViewHolder(
            FragmentReceiptItemBinding.inflate(
    ...
    inner class ViewHolder(binding: FragmentReceiptItemBinding) :
